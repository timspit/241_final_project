...
_We still collected more data for all arms to confirm that of design, Con + Pure was most impactful (see \autoref{tab:allarmsmodel})_  
...
stargazer(model_pureext_react$lm
          # , model_libpure_react$lm
          # , model_confair_react$lm
          # , model_conpure_react$lm
          , se = list(model_pureext_react$se_robust
                      # , model_libpure_react$se_robust
                      # , model_confair_react$se_robust
                      # , model_conpure_react$se_robust
                      )
          , type = stargazer_type, header = F
          , title = "By Arm"
          # , column.labels = c("Lib + Fair", "Lib + Pure"
