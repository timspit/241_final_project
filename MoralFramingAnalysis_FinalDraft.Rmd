...
- The will of the narrator to persevere through the cold weather
- Fear for the narrator's safety
- Empathy for the narrator's plight
- Indignation for the narrator's misfortunes
- The betrayal of friendship from fellow students
- Respect and admiration for the teacher
...
As mentioned in the previous section, we developed two treatment options, one for each of the two moral foundations included in our experiment. The survey procedures were designed in Qualtrics, and distribution was handled in Prolific.
...
_\autoref{fig:study_flowchart}_ in **Appendix D** offers a detailed description of the four treatment arms and control arm for the experiment. Participants were randomly assigned to one of the five arms using five-way random sampling without replacement executed within the Qualtrics survey platform. If subjects received treatment, they were asked to rate their feelings about the story they  read and enter some text to describe why they felt the way they did. The feeling check questions would vary depending on the stories read.
...
Distribution was completed in waves. Overall, there were 4 waves for conservatives and 2 waves for liberals. _\autoref{tab:waves_table}_ in **Appendix D** offers a detailed description of the waves of participants collected.  
...
\label{tab:waves_table} Study Waves
