...
```{r import}
results_raw_panel1 = read.csv("./data/study/MF Framing Pilot - Full Recruitment - Panel 1_November 26, 2019_23.11.csv", stringsAsFactors = FALSE) %>%   filter(!grepl("Start|Import", StartDate)) %>% 
  mutate(panel = 1)
...
#  filter(!grepl("Start|Import", StartDate)) %>% 
#  mutate(panel = 2)
# results_raw_panel2_nov24 = read.xlsx("./data/study/MF Framing Pilot - Full Recruitment - Panel 2_November 24, 2019_21.30.xlsx") %>% 
#   filter(!grepl("Start|Import", StartDate)) %>% 
#   mutate(panel = 2)
...
participant_detail_1 = read.csv("./data/study/prolific_export_5dd4a34135582248315dfdca-up-to_November_26_2019.csv", stringsAsFactors = FALSE)
participant_detail_2 = read.csv("./data/study/prolific_export_5dd86d9f8f45b98265115ada.csv", stringsAsFactors = FALSE)
participant_detail_3 = read.csv("./data/study/prolific_export_5dd4a350108b6748b25b5de1-up-to_November_26_2019.csv", stringsAsFactors = FALSE)
```
