...
```{r import}
results_raw_panel1 = read.csv("./data/study/MF Framing Pilot - Full Recruitment - Panel 1_November 27, 2019_00.23.csv", stringsAsFactors = FALSE) %>%   filter(!grepl("Start|Import", StartDate)) %>% 
  mutate(panel = 1)
