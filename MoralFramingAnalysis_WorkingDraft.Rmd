...
all_data[ panel==1 & arm != 'care_base' & arm != 'care_extension', .(ubi=as.numeric(UBI_2), panel, arm), ][, lm(ubi~arm)]
# conservatives - homeless story
all_data[ panel==2 & arm != 'care_base' & arm != 'care_extension', .(ubi=as.numeric(UBI_2), panel, arm), ][, lm(ubi~arm)]

# liberals - jacket story
all_data[ panel==1 & arm != 'purity_base' & arm != 'purity_extension', .(ubi=as.numeric(UBI_2), panel, arm), ][, lm(ubi~arm)]
# conservatives - jacket story
all_data[ panel==2 & arm != 'purity_base' & arm != 'purity_extension', .(ubi=as.numeric(UBI_2), panel, arm), ][, lm(ubi~arm)]
```
