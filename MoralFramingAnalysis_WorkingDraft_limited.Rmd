...
subtitle: "W241 Experiments and Causality (submitted December 10, 2019)"
...
results_armconpur_balance = results_armconpur[results_armconpur$recruitment_day!='Friday',]
...
```{r model_test_recruitday, echo = FALSE, fig.height = 4, fig.width = 4, fig.align="center", fig.cap="\\label{fig:model_0}Model 0", results='asis'}
...
results_armconpur_strat = svydesign(id=~1, strata=~recruitment_day, data = results_armconpur)
